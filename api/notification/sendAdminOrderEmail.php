...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        $orderobj->SendOrderEmailToAdmin('info@pinnaclemachinery.co.uk',$_POST['user'],$_POST['email'],$_POST['amount'],$_POST['trackingnumber'],$_POST['weight'],$status,$_POST['barcode']);
